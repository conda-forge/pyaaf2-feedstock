...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyaaf2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12702&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyaaf2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyaaf2` can be installed with:

```
conda install pyaaf2
```

It is possible to list all of the versions of `pyaaf2` available on your platform with:
